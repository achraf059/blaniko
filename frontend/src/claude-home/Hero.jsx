...
export const Hero = () => {
  ...
  const tags = [
    ...
    { label: dictionary.claudeHome.heroTagOutdoor,  icon: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><path d="M12 3a7 7 0 0 1 7 7c0 4-7 13-7 13S5 14 5 10a7 7 0 0 1 7-7z"/></svg> },
