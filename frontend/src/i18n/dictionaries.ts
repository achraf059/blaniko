...
const en: Dictionary = {
  ...
  claudeHome: {
    ...
    howTitleSuffix: "go.",
    footerCtaTitlePrefix: "Get Casablanca",
    footerCtaTitleEmphasis: "plans every Friday",
    footerEmailPlaceholder: "your@email.com",
    footerSmallNote: "Five hand-picked ideas every Friday — places, activities, weekend plans. No spam.",
...
const fr: Dictionary = {
  ...
  claudeHome: {
    ...
    footerCtaTitlePrefix: "Recevez vos plans",
    footerCtaTitleEmphasis: "Casablanca chaque vendredi",
    footerEmailPlaceholder: "votre@email.com",
    footerSmallNote: "Cinq idées sélectionnées chaque vendredi — adresses, activités, plans week-end. Pas de spam.",
