...
const byLanguage = {
  en: {
    ...
    guidesPage: {
      ...
      title: "Casablanca guides for every mood",
    ...
    recommendationsPage: {
      ...
      quiz: {
        promiseLead: "Three questions. Blaniko builds a ",
        promiseEmphasis: "3-stop outing",
        promiseTail: " in Casablanca — a start, a main stop, a finish.",
        ready: "Ready",
        buildOuting: "Build my outing",
        trust: "Real Casablanca venues · No account needed · Change any stop after",
        helperCompanion: "This sets who the outing is built around.",
        helperCategory: "This becomes the main stop of your outing.",
        helperVibe: "This sets the pace and the order of your stops.",
        descCompanion: {
          alone: "Time for yourself, at your own pace.",
          friends: "A group plan with room to move.",
          family: "Something that works for every age.",
          partner: "A plan for two.",
        },
        descCategory: {
          activities: "Experiences to break your routine and explore the city.",
          sports: "Padel, fitness, and active spots around town.",
          gaming: "Arcades, lounges, and social gaming spots.",
          outdoor: "Fresh-air plans across Casablanca.",
          family: "Kid-friendly venues and family activities.",
          wellness: "Spas, hammams, and relaxing escapes.",
        },
        descVibe: {
          chill: "Low-key, unhurried, quiet-first.",
          social: "Lively, easy to share with a group.",
          active: "Movement first, energy throughout.",
          romantic: "Slower, more intimate stops.",
          "family-friendly": "Easy logistics, comfortable for kids.",
        },
        consequenceCompanion: {
          alone: "Every stop is built around your own pace.",
          friends: "Every stop has to work for a group.",
          family: "Every stop has to work for every age.",
          partner: "Every stop is built for the two of you.",
        },
        consequenceCategory: "The one stop you choose directly.",
        consequenceVibe: "Sets the pace and the order of your three stops.",
        profileSub: "Three stops, built from your answers.",
        titleReadyPrefix: "Ready to ",
        titleReadyEmphasis: "build",
        titleReadySuffix: "",
        promptCompanion: "Choose who's joining",
        promptCategory: "Choose an experience",
        promptVibe: "Choose how it should feel",
        routeLabel: "The route",
        stopsTotal: "3 stops",
        stopsOpen: "{count} stops open",
        stopsSet: "3 stops set",
        nodeStart: "Start",
        nodeMain: "Main stop",
        nodeEnd: "To finish",
        nodeWaiting: "Waiting on your answers",
        nodeSetByVibe: "Set by the vibe you pick",
        nodeSetByCategory: "Set by what you're looking for",
        nodeMainAnchorSuffix: "anchors your main stop",
        revealLead: "This looks like",
        revealSwitch: "You can switch it after.",
        footEmpty: "Nothing chosen yet.",
      },
    },
    venuePage: {
    ...
    planPage: {
      ...
      heroSubtitle: "Blaniko picked 3 places based on your answers. Fine-tune the plan or share it and go.",
      previewNote: "Preview Blaniko's smart planning experience — designed for the future mobile app.",
      chooseVibeHeading: "Your plan style",
      vibeSubtitle: "Blaniko picked this style based on your answers. Switch it anytime to reshape your outing.",
      ...
      assureMadeForYouDesc: "Based on your choices and vibe.",
  ...
  fr: {
    ...
    guidesPage: {
      eyebrow: "Les choix Blaniko",
      title: "Guides de Casablanca pour toutes les envies",
      ...
      filters: "Filtres",
      moodTitle: "Parcourir les guides",
    ...
    recommendationsPage: {
      ...
      quiz: {
        promiseLead: "Trois questions. Blaniko compose une ",
        promiseEmphasis: "sortie en 3 étapes",
        promiseTail: " à Casablanca — un départ, une étape principale, une fin.",
        ready: "Prêt",
        buildOuting: "Composer ma sortie",
        trust: "Vrais lieux à Casablanca · Sans compte · Modifiez chaque étape ensuite",
        helperCompanion: "Cela définit autour de qui la sortie est construite.",
        helperCategory: "Cela devient l'étape principale de votre sortie.",
        helperVibe: "Cela définit le rythme et l'ordre de vos étapes.",
        descCompanion: {
          alone: "Du temps pour vous, à votre rythme.",
          friends: "Un plan de groupe avec de la marge.",
          family: "Quelque chose qui convient à tous les âges.",
          partner: "Un plan à deux.",
        },
        descCategory: {
          activities: "Des expériences pour sortir de la routine et explorer la ville.",
          sports: "Padel, fitness et spots actifs en ville.",
          gaming: "Salles d'arcade, lounges et spots de jeu conviviaux.",
          outdoor: "Des plans en plein air à travers Casablanca.",
          family: "Des lieux et activités adaptés aux enfants.",
          wellness: "Spas, hammams et évasions relaxantes.",
        },
        descVibe: {
          chill: "Tranquille, sans précipitation, calme d'abord.",
          social: "Animé, facile à partager en groupe.",
          active: "Le mouvement d'abord, de l'énergie tout du long.",
          romantic: "Plus lent, des étapes plus intimes.",
          "family-friendly": "Logistique facile, confortable pour les enfants.",
        },
        consequenceCompanion: {
          alone: "Chaque étape est pensée pour votre propre rythme.",
          friends: "Chaque étape doit fonctionner pour un groupe.",
          family: "Chaque étape doit convenir à tous les âges.",
          partner: "Chaque étape est pensée pour vous deux.",
        },
        consequenceCategory: "La seule étape que vous choisissez directement.",
        consequenceVibe: "Définit le rythme et l'ordre de vos trois étapes.",
        profileSub: "Trois étapes, construites à partir de vos réponses.",
        titleReadyPrefix: "Prêt à ",
        titleReadyEmphasis: "composer",
        titleReadySuffix: "",
        promptCompanion: "Choisissez qui vous accompagne",
        promptCategory: "Choisissez une expérience",
        promptVibe: "Choisissez l'ambiance",
        routeLabel: "Le parcours",
        stopsTotal: "3 étapes",
        stopsOpen: "{count} étapes à définir",
        stopsSet: "3 étapes définies",
        nodeStart: "Départ",
        nodeMain: "Étape principale",
        nodeEnd: "Pour finir",
        nodeWaiting: "En attente de vos réponses",
        nodeSetByVibe: "Défini par l'ambiance choisie",
        nodeSetByCategory: "Défini par ce que vous recherchez",
        nodeMainAnchorSuffix: "ancre votre étape principale",
        revealLead: "Ça ressemble à",
        revealSwitch: "Vous pourrez changer ensuite.",
        footEmpty: "Rien de choisi pour l'instant.",
      },
    },
    venuePage: {
    ...
    planPage: {
      ...
      heroSubtitle: "Blaniko a choisi 3 lieux selon tes réponses. Ajuste le plan ou partage-le et lance ta sortie.",
      ...
      chooseVibeHeading: "Le style de ta sortie",
      vibeSubtitle: "Blaniko a choisi ce style selon tes réponses. Change-le à tout moment pour adapter ta sortie.",
      ...
      assureMadeForYouDesc: "Basé sur tes choix et ton ambiance.",
