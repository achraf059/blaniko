          ...
          <div className="relative grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <div>
              ...
              <p className="mt-3 text-sm text-slate-700">
                {dictionary.venuePage.area}: <span className="font-medium">{venue.area}</span>
              </p>
        ...
        <section className="mt-8 grid gap-4 md:gap-5 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <div className="grid gap-3">
            ...
            <div className="rounded-2xl border border-[#d9cebe] bg-[#f8f2e8] p-4">
              ...
              <p className="mt-2 text-sm font-medium text-slate-800">{audience}</p>
            </div>
            ...
            <div className="rounded-2xl border border-[#d9cebe] bg-[#f8f2e8] p-4">
              ...
              <p className="mt-2 text-sm font-medium text-slate-800">{priceLevel}</p>
            </div>
          </div>
        </section>
      </main>
